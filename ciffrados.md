...
3DES , CVE-2016-2183 (también conocido como "Sweet32") es una vulnerabilidad en los algoritmos de ci-frado DES/3DES que afecta a varias implementaciones de TLS y SSH. Es un tipo de ataque de cum-pleaños que permite colisiones cuando se usan cifrados débiles.
Ataque de Cumpleaños:  El servidor web cifra los datos mediante claves criptográficas. Estas claves se eligen aleatoriamente, y la probabilidad de que dos clientes obtengan la misma clave es muy baja. Al hacer un mal uso de la vulnerabilidad SWEET32 , un atacante puede enviar un gran volumen de datos ficticios y obtener bloques de texto cifrado que coinciden con los de un cliente
